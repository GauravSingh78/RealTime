...
model2 = RandomForestRegressor(n_estimators=10,max_depth=15) 

# Train the model on the training data
model2.fit(x1, y1)
model3 = RandomForestRegressor(n_estimators=10,max_depth=15) 

# Train the model on the training data
model3.fit(x2, y2)
model4 = RandomForestRegressor(n_estimators=10,max_depth=15) 

# Train the model on the training data
model4.fit(x3, y3)
model5 = RandomForestRegressor(n_estimators=10,max_depth=15) 
